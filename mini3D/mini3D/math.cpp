...
void vector_TransformCoord(vector_t* VOut, vector_t* vIn, matrix_t* M) {
	VOut->x = vIn->x * M->m[0][0] + vIn->y * M->m[1][0] + vIn->z * M->m[2][0] + M->m[3][0];
	VOut->y = vIn->x * M->m[0][1] + vIn->y * M->m[1][1] + vIn->z * M->m[2][1] + M->m[3][1];
	VOut->z = vIn->x * M->m[0][2] + vIn->y * M->m[1][2] + vIn->z * M->m[2][2] + M->m[3][2];
